...
# Fix the imports in network/main.py to work from the current directory
...
echo "✅ Fixed import issues in main.py and node.py"
echo ""
echo "Now you can run the genesis node with:"
echo "  cd network"
