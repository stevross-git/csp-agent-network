...
import { apiFallbackData } from "@/utils/apiFallbackData";
class ApiClient {
  constructor(options = {}) {
  ...
  enableDebug() {
    this.addRequestInterceptor((config) => {
      console.group(
        `🚀 API Request: ${config.method} ${config.url || "unknown"}`,
      );
...
window.ApiClient = new ApiClient({ fallbackData: apiFallbackData });
